...
const CreateNew = (props) => {
  ...
  const {reset: reset_content, ...content_properties } = content
  const {reset: reset_autor, ...author_properties } = author
  const {reset: reset_info, ...info_properties } = info
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          content
          <input name='content' {...content_properties} />
        </div>
        <div>
          author
          <input name='author' {...author_properties} />
        </div>
        <div>
          url for more info
          <input name='info' {...info_properties} />
        </div>
